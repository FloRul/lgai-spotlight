...
abstract class $ChatMessagesStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<ChatMessage> messages, bool isLoading, bool hasError});
}
...
class _$ChatMessagesStateImpl implements _ChatMessagesState {
  const _$ChatMessagesStateImpl(
      {required final List<ChatMessage> messages, required this.isLoading, required this.hasError})
      : _messages = messages;
